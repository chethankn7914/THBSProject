...
public class UserController {
    ...
    public  ModelAndView getUserlogData(@ModelAttribute("user") User ussr)
    {
		...
		System.out.println(existing+"user existinng check"+"came from login");
	...
	@RequestMapping(value="/deleteTrain/{trNo}",method=RequestMethod.POST,produces = "application/json", consumes = "application/json")
	...
	public String Adminlogin(HttpServletRequest request,Model model) {
		...
		if (aname != null) {
			model.addAttribute("admin",aname);
			return "admin_pannel";
		}else {
			model.addAttribute("admin_error","Invalid Admin Name and Password");
